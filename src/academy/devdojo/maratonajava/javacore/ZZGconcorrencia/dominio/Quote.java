package academy.devdojo.maratonajava.introducao.src.academy.devdojo.maratonajava.javacore.ZZGconcorrencia.dominio;
...
public final class Quote {
    ...
    public static Quote newQuote(String value){
        ...
        String replace_value = values[1].replace(",",".");
        return new Quote(values[0], Double.parseDouble(replace_value), Discount.Code.valueOf(values[2]));
